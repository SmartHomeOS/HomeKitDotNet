...
internal class Program
{
    ...
    {
        IPEndPoint ep = new IPEndPoint(IPAddress.Parse("10.50.42.103"), 21067);
        ...
        byte[] AccessoryID = Encoding.UTF8.GetBytes("15:7B:84:9B:5E:A5");
        byte[] AccessoryLTPK = [0x44, 0xEF, 0x00, 0xEB, 0x1E, 0x94, 0x3F, 0xC9, 0xC4, 0x74, 0x30, 0xF2, 0x8A, 0x10, 0x6B, 0xFB, 0x9D, 0x0B, 0x33, 0x09, 0xB9, 0x6A, 0x0B, 0xE8, 0xE5, 0x57, 0xF1, 0x9E, 0x69, 0xDF, 0x44, 0xB3];

        Controller controller = new Controller(LTSK, LTPK, DeviceID);
        //var pairing = await controller.Pair(parser.SetupPin, ep);
        HomeKitEndPoint connection = await controller.Connect(ep, AccessoryID, AccessoryLTPK);
